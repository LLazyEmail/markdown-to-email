...
describe('Footer/TableLeft component testing to correct links and attributes', () => {
    it('First TableLeft element has correct attributes, links', () => {
        ...
        expect(table.at(0).props()).toHaveProperty('src', 'https://cdn-images.mailchimp.com/icons/social-block-v2/gray-twitter-48.png');
    ...
    it('Second TableLeft element has correct attributes, links', () => {
        ...
        expect(table.at(1).props()).toHaveProperty('src', 'https://cdn-images.mailchimp.com/icons/social-block-v2/gray-facebook-48.png');
    ...
    it('Third TableLeft element has correct attributes, links', () => {
        ...
        expect(table.at(2).props()).toHaveProperty('src', 'https://cdn-images.mailchimp.com/icons/social-block-v2/gray-instagram-48.png');
    ...
    it('Fourth TableLeft element has correct attributes, links', () => {
        const wrapper = shallow(<Footer />);
        const table = wrapper.find('TableLeft');
        expect(table.at(3).props()).toHaveProperty('href', 'http://hackernoon.com');
        expect(table.at(3).props()).toHaveProperty('src', 'https://cdn-images.mailchimp.com/icons/social-block-v2/gray-link-48.png');
    ...
    it('Fifth TableLeft element has correct attributes, links', () => {
        ...
        expect(table.at(4).props()).toHaveProperty('src', 'https://cdn-images.mailchimp.com/icons/social-block-v2/gray-youtube-48.png');
    ...
    it('Sixth TableLeft element has correct attributes, links', () => {
        ...
        expect(table.at(5).props()).toHaveProperty('src', 'https://cdn-images.mailchimp.com/icons/social-block-v2/gray-forwardtofriend-48.png');

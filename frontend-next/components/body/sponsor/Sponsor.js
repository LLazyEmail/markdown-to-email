...
const Sponsor = ({leftHref, leftSrc, rightHref, children}) => {
  return (
    <table
      ...
      cellPadding={0}
      cellSpacing={0}
      className="mcnImageCardRightContentOuter" width="100%" style={styles.imageCardRightContentOuter}>
      <tbody>
        <tr>
          <td align="center" valign="top" className="mcnImageCardRightContentInner" style={styles.imageCardRightContentInner}>
            <table align="left"
              ...
              cellPadding={0}
              cellSpacing={0}
              className="mcnImageCardRightImageContentContainer" width={200} style={styles.imageCardRightContentContainer}>
              <tbody>
                <tr>
            ...
            <table className="mcnImageCardRightTextContentContainer" align="right"
              border={0}
              cellPadding={0}
              cellSpacing={0}
              width={346} style={styles.imageCardRightContentContainer}>
              <tbody>
                <tr>

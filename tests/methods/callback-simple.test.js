...
const { strong, link, blockquote, mem, header } = PlainCallbacks;
...
describe('testing callback-simple', () => {
  ...
  test('link return a link element ', () => {
    ...
    expect(lnk).toBe(
      '<a href="google.com" target="_blank" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #111111;font-weight: bold;text-decoration: underline;">google</a>',
    );
  });

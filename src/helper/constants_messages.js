...
export const WARNING_IMAGE_VERSION = (index, element) =>
  `WARNING source.md has ${index} ${element}. Replace it with memes`;
// eslint-disable-next-line no-undef
export const ERROR_SOURCE_DONT_HAVE = (error) =>
  `ERROR source.md doesn't have ${error}`;

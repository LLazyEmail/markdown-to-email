...
var copyrights = `<em>Copyright © ${new Date().getFullYear()} Hacker Noon. All rights reserved.</em>`;
...
var config$2 = /*@__PURE__*/getAugmentedNamespace(config$1);

var address = `<strong>Our mailing address is:</strong>
<br>
${config$2.mailingAddress}`;

var address$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.assign(/*#__PURE__*/Object.create(null), address, {
  'default': address
}));

var unsubscribe = `<a href="${config$2.unsubscribe}" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #656565;font-weight: normal;text-decoration: underline;">
unsubscribe
</a>`;
...
var newsletterSponsorshipLink = `<div style="text-align: center;">
<br>
<a href="${config$2.contact}" target="_blank" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #656565;font-weight: normal;text-decoration: underline;">
...
var list = `<ul dir="ltr">{content}</ul>`;
